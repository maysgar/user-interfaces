...
function startGame(){
  ...
  var display = "";
	...
	for(var i = 0; i< y3; i++){
			...
			//ISMA AQUI ES DONDE PEPITA PERDIO A SU GATITO Y POR DONDE TU TIENES QUE SEGUIR ESCRIBIENDO CODIGO
			
			else if(y1 == 6){ 
				if(i == 0 || i == 4 || i == 8){
					$("#panel_"+i).css({"width": "200px","height": "200px", "margin-left": "15%", "margin": "10px" , "float": "left","transform-style": "preserve-3d","transition":"all 0.5s"});
				}
				else{
					$("#panel_"+i).css({"width": "200px","height": "200px","margin": "10px" , "float": "left","transform-style": "preserve-3d","transition":"all 0.5s"});
					$(".img").css({"width":"200px","height":"200px"});
